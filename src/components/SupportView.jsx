...
const FAQ_ITEMS = [
  {
    ...
    a: 'За кожну виконану задачу ви отримуєте бали. Бонусні задачі дають тільки позитивні бали. Для щоденних задач, якщо ви їх не виконаєте — бали можуть не нарахуватися. Знизу сторінки ви бачите максимальну можливу кількість балів за день та тиждень.'
  },
  {
    q: 'Як працюють ліміти?',
    a: 'Ліміт — це задача, де потрібно НЕ перевищити кількість. Наприклад, "Алкоголь — макс 2 рази на тиждень". Якщо вкладаєтесь у ліміт — отримуєте бали. Перевищили — можете отримати штраф.'
  },
  {
    q: 'Де зберігаються мої дані?',
    a: 'Якщо ви авторизовані, всі дані автоматично зберігаються в хмарі та синхронізуються між вашими пристроями. Якщо ви використовуєте додаток без реєстрації — дані зберігаються лише у вашому браузері.'
  },
  {
    q: 'Як працює система "Сім\'я"?',
    a: 'Ви можете створити сім\'ю і запросити туди родичів або дітей. Батьки можуть створювати задачі для дітей і вмикати "батьківський контроль" — тоді задача зарахується лише після того, як ви її перевірите та підтвердите.'
  },
  {
    q: 'Як перенести дані на інший пристрій?',
    a: 'Просто увійдіть у свій акаунт за допомогою Email на новому пристрої, і ваші задачі завантажаться автоматично. Ви також можете експортувати/імпортувати дані через JSON файл у бічному меню для ручного резервного копіювання.'
  },
  {
    q: 'Як працюють бонусні рівні (челленджі)?',
    a: 'Бонусні рівні — це додаткові бали за перевиконання. Наприклад, якщо ціль тренування — 3 рази на тиждень, але ви тренувались 5 разів, ви отримуєте базову винагороду + бонус за досягнення 5-ти разів.'
  },
  {
    q: 'Можна мати декілька профілів?',
    a: 'Так! Кожен користувач може створити декілька локальних профілів (наприклад, для себе і дитини, якщо ви граєте з одного пристрою). Але для повноцінної роботи ми рекомендуємо створити кожному окремий акаунт і об\'єднати їх через "Сім\'ю".'
  },
];
      ...
      <div className="card">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
          <div className="tech-info-row">
            ...
            <div className="tech-info-value">1.2.0 (Cloud Sync & Family)</div>
          </div>

          <div className="tech-info-row">
            <div className="tech-info-label">
              <Database size={16} /> Локальний кеш
            </div>
          ...
          <div className="tech-info-row">
            ...
            <div className="tech-info-value">
              {supabase ? 'Хмарне (Supabase) + Локальне' : 'Тільки локальне (без бекапу)'}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, color: '#fb923c', fontSize: 'var(--font-sm)' }}>
              ...
              <span>
                Незважаючи на наявність хмарного збереження, ми рекомендуємо регулярно робити резервну копію ваших даних (Експорт JSON) на випадок збоїв.
              </span>
            </div>
          </div>
